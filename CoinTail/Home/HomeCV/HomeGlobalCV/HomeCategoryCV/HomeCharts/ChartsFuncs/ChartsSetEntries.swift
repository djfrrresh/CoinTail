...
extension HomeCategoryCell {
    ...
    func setEntries(_ segment: RecordType) {
        ...
        let chartSections = setDictionary(segment)
    ...
    private func setDictionary(_ segment: RecordType) -> [String: [Record]] {
        return Dictionary(grouping: Records.shared.getRecords(for: segment), by: {
